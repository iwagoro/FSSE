...
def main():
    ...
    # モデルの初期化
    model = DN(dim=64)
    checkpoint = torch.load("/workspace/app/FSSE/checkpoints/few_shot_noisy_to_clean_without_pretrain/model-epoch=35-step=2160-val_loss=-0.98.ckpt")  # 予測に使用するモデルのチェックポイント
